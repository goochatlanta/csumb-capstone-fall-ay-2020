...
def main():
    ...
    localSources = ["onlinenigeria.com", "allafrica.com", "punchng.com", "sunnewsonline.com", "thisdaylive.com", "thenationonlineng.net", "leadership.ng", "today.ng", "dailytrust.com.ng"]
