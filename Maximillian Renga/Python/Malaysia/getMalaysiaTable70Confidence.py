...
def main():
    ...
    minimumConfidenceLevel = 70
    localSources = ["thestar.com.my", "themalaymailonline.com", "malaysia-chronicle.com", "freemalaysiatoday.com", "malaysiakini.com", "malaysiandigest.com", "theborneopost.com", "thesundaily.my", "nst.com.my", "bernama.com"]
...
def generateCSVResults(targetCountry, resultsDict):
    with open(targetCountry + "_70Confidencetable.csv", 'w') as csvfile:
